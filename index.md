...
<dl>
   ...
   <dt>Tools of Choice</dt>
      <dd><span class = "label color-6">LaTeX</span> <span class = "label color-6">Zotero</span> <span class = "label color-6">LimeSurvey</span> <span class = "label color-6">R</span> <span class = "label color-6">Python</span></dd>
</dl>
